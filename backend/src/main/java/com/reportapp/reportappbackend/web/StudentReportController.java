...
import com.reportapp.reportappbackend.web.dto.StudentReportItemDefinitionsResponse;
...
public class StudentReportController {
    ...
    public ResponseEntity<?> listItemDefinitions(
        ...
        return ResponseEntity.ok(new StudentReportItemDefinitionsResponse(
                goalMapper.existsCoveringDate(principal.getId(), reportDate),
                reportItemDefinitionService.listApplicable(principal.getId(), reportDate)));
    }
